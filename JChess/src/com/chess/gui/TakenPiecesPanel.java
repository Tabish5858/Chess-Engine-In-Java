...
class TakenPiecesPanel extends JPanel {
    ...
    public void clear() {
        removeAll(); // Assuming removeAll() is a method to remove all components in your panel
        revalidate();
        repaint();
        // Add any additional code to reset or clear data structures related to taken pieces
    }
